...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //|----------+----------+----------+----------+----------+----------+----------`  `----------+----------+----------+----------+----------+----------+----------|
                                                      KC_LCTL,     LOWER,    KC_SPC,       KC_ENT,     RAISE,   TD(ALT)
    //                                            |----------+----------+----------|  |----------+----------+----------|
    ),
    ...
    //|----------+----------+----------+----------+----------+----------|                        |----------+----------+----------+----------+----------+----------|
          KC_LCTL,    RALT_1, RALT_SLSH,      WAVE,   VERTBAR,     GRAVE,                            XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,
    //|----------+----------+----------+----------+----------+----------+----------`  `----------+----------+----------+----------+----------+----------+----------|
    ...
    //|----------+----------+----------+----------+----------+----------|                        |----------+----------+----------+----------+----------+----------|
          UG_TOGG,   RGB_M_P,   RGB_M_B,   RGB_M_R,  RGB_M_SW,   XXXXXXX,                            XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,
    //|----------+----------+----------+----------+----------+----------|                        |----------+----------+----------+----------+----------+----------|
